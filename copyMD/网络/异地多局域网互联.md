...
![image-20230915235129936](C:\Users\kenger\AppData\Roaming\Typora\typora-user-images\image-20230915235129936.png)
...
```
curl --interface vth1 -X GET 10.1.1.1
curl --interface vth2 -X GET 10.1.1.1
curl --interface vth3 -X GET 10.1.1.1
curl --interface vth4 -X GET 10.1.1.1
curl --interface vth5 -X GET 10.1.1.1
```
...
`*/5 * * * * /bin/bash /root/csu_net_keep/run_script.sh`
